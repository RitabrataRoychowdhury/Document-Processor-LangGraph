...
try:
    ...
    from src.services.qme_template_generator import QMETemplateGenerator, create_qme_template_generator
    from src.utils.logging_config import get_logger
    from src.utils.error_handling import RetryableException, NonRetryableException
except ImportError:
    from commands.base import Command, CommandResult
    from services.qme_template_generator import QMETemplateGenerator, create_qme_template_generator
