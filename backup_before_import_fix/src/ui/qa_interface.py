...
def _get_context_aware_suggestions(document: Document) -> List[str]:
...
def _process_enhanced_question(question: str, document: Document, session_id: str, context_aware: bool) -> None:
