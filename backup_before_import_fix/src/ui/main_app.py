...
def main():
    """Enhanced main application entry point with dual-pipeline integration"""
    ...
    # Enhanced main content area with dual-pipeline workflow support
    try:
        # Map page names to clean identifiers
        page_clean = page.split(' ', 1)[-1] if ' ' in page else page
        
        if page_clean == "Upload Documents":
            if upload_interface:
                render_enhanced_upload_page(upload_interface)
            else:
                st.error("Upload interface not available")
                
        elif page_clean == "Extract & Validate":
            render_extraction_validation_page()
            
        elif page_clean == "Generate QME Template":
            render_enhanced_qme_template_page()
            
        elif page_clean == "Professional Assembly":
            render_enhanced_professional_template_page()
            
        elif page_clean == "Q&A Interface":
        ...
        elif page_clean == "Workflow Dashboard":
            render_workflow_dashboard_page()
            
        elif page_clean == "Performance Monitor":
            render_enhanced_performance_monitor_page()
            
        elif page_clean == "System Status":
            render_enhanced_system_status_page()
            
        elif page_clean == "Knowledge Base Setup":
            render_enhanced_knowledge_base_setup_page()
            
        elif page_clean == "Document Management":
        ...
        elif page_clean == "Data Migration":
        ...
        _render_error_recovery_interface(e, page)
...
def render_enhanced_upload_page(upload_interface: UploadInterface):
    """Render enhanced document upload page with dual-pipeline integration."""
