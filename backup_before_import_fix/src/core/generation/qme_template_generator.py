...
try:
    ...
    from src.core.extraction.ingestion_pipeline import MedicalNERExtractor, ExtractedEntity
    ...
    from core.extraction.ingestion_pipeline import MedicalNERExtractor, ExtractedEntity
