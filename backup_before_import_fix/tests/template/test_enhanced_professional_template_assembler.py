...
try:
    ...
    from src.services.qme_template_generator import QMETemplateData, PatientInfo, MedicalFindings, Diagnosis, ImpairmentRating
    from src.services.qme_field_validator import ValidationReport, ValidationStatus, EvidenceSnippet
    from src.services.impairment_calculator import ProgrammaticCalculationResult, CalculationStep, AMATableReference, ROMMeasurement
...
def create_mock_validation_report() -> ValidationReport:
    ...
    from src.services.qme_field_extractor import DocumentCoordinate
