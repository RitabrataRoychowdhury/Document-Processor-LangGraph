...
echo ""
print_status "Cleaning up Task 5 validation data..."
...
find . -name "*validation_test*" -type f -delete 2>/dev/null || true
find . -name "comprehensive_system_validation_*.json" -type f -delete 2>/dev/null || true
find . -name "knowledge_base_validation_*.json" -type f -delete 2>/dev/null || true
find . -name "pipeline_integration_test_*.json" -type f -delete 2>/dev/null || true
find . -name "evidence_validation_*.json" -type f -delete 2>/dev/null || true
find . -name "calculation_validation_*.json" -type f -delete 2>/dev/null || true
find . -name "compliance_report_*.json" -type f -delete 2>/dev/null || true
...
find . -name "*task5_test*" -type f -delete 2>/dev/null || true
find . -name "*validation_mock*" -type f -delete 2>/dev/null || true
find . -name "test_extraction_*.json" -type f -delete 2>/dev/null || true
find . -name "mock_template_*.docx" -type f -delete 2>/dev/null || true
...
echo "   ✅ Task 5 validation data cleared"
echo "   ✅ Validation reports removed"
echo "   ✅ Validation test artifacts cleared"
echo "   ✅ Performance metrics cleared"
echo "   ✅ Log files removed"
echo "   ✅ Python cache cleared"
echo "   ✅ Test artifacts removed"
echo "   ✅ QME test files removed"
echo "   ✅ Task 5 validation test files removed"
...
echo "   • Task 5 validation reports and test data"
echo "   • Validation cache and temporary files"
echo "   • Knowledge base validation results"
echo "   • Pipeline integration test artifacts"
echo "   • Evidence validation test data"
echo "   • Calculation validation test results"
echo "   • Compliance and quality validation reports"
...
echo "   • Task 5 validation test artifacts"
echo ""
